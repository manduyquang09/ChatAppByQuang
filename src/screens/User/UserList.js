import { View, Text, StatusBar, FlatList, Keyboard, Alert, TouchableOpacity } from 'react-native'
...
const UserList = ({ navigation }) => {
    ...
    const createChatList = (data) => {
        ...
        const chatListRef = ref(firebaseDatabase, "chatList/" + currentUser.userId + "/" +
            data.userId)
        ...
        get(chatListRef).then((snapshot) => {
            if (snapshot.exists()) {
                ...
                update(ref(firebaseDatabase, "chatList/" + data.userId + "/" + currentUser.userId),
                    { ...myChatList }).then(() => {
                ...
                update(ref(firebaseDatabase, "chatList/" + currentUser.userId + "/" + data.userId), {
                    ...data
                }).then(() => {
    ...
    return (
        ...
        >
            ...
            >Lout out</Text></TouchableOpacity>
        </View >
    )
}
